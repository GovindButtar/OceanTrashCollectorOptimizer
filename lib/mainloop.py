...
###############################################################################
def simulatePos(N, sampleTime, vehicle, currentDepth, currentHeading, currentSpeed, currentDirection):
    
    DOF = 6                     # degrees of freedom
    t = 0                       # initial simulation time

    # Initial state vectors
    eta = np.array([currentDepth, currentHeading, 0,currentSpeed, currentDirection], float)    # position/attitude, user editable
